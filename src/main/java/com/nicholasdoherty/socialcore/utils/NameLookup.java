 ...
 * Source: https://bukkit.org/threads/player-name-history-lookup.412679/
 * All credits to original author, only minor alterations have been made
 * @since 25-3-2016
 */
public class NameLookup {
    ...
    public class PreviousPlayerNameEntry {
        ...
        private String prettyChangeDate;
         ...
         */
        public long getRawChangeTime() {
            return changeTime;
        }

        /**
         * Get the time of change of the name, but prettified.
         * <br><b>Note: This already takes into consideration if the player has never chanted their name
         * @return a string with the formatted timestamp :)
         */
        public String getChangeTime() {
            Date d = new Date();
            d.setTime(changeTime);
            DateFormat df = new SimpleDateFormat("hh:mm MMM dd, yyyy");
