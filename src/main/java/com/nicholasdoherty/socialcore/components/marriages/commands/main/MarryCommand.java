    ...
    public void onCommand(CommandSender sender, String[] args) {
        ...
        Bukkit.getScheduler().runTaskAsynchronously(sc, () -> {
            ...
            if (args.length > 1) {
                ...
                if (!player1.getEngagedTo().equalsIgnoreCase(player2.getUUID())) {
                    player.sendMessage(ChatColor.RED + player1.getPlayerName() + " is not engaged to " + player2.getPlayerName());
                    return;
                }
                if (!player2.getEngagedTo().equalsIgnoreCase(player1.getUUID())) {
                ...
                player1.setMarriedTo(player2.getUUID());
                player2.setEngaged(false);
                player2.setEngagedTo("");
                player2.setMarried(true);
                player2.setMarriedTo(player1.getUUID());
