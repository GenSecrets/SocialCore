 ...
 */
public class FinePlantiff implements PostCourtAction,ConfigurationSerializable {
    private int amount;
    private int cazeId;

    public FinePlantiff(int amount, Case caze) {
        this.amount = amount;
    ...
    public String prettyDescription() {
        return ChatColor.GOLD + "The plaintiff will be fined " + amount + " voxels";
    }
    public FinePlantiff(Map<String, Object> map) {
