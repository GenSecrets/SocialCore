...
public enum ParticleEffect {
	...
	static {
		...
		try {
			PARTICLE_PACKET_CONSTRUCTOR = ReflectionUtil.getConstructor(ReflectionUtil.getClass("Packet63WorldParticles", ReflectionUtil.DynamicPackage.MINECRAFT_SERVER));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
